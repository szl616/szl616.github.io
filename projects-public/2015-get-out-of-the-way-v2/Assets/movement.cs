...
public class movement : MonoBehaviour {
	...
	void Start () {
		...
		case 1: Health = 100 + PlayerPrefs.GetInt("Car1Armor");
			break;
		
		case 2: Health = 300 + PlayerPrefs.GetInt("Car2Armor");
			break;
		
		case 3: Health = 500 + PlayerPrefs.GetInt("Car3Armor");
			break;
		
		case 4: Health = 1000 + PlayerPrefs.GetInt("Car4Armor");
			break;
		
		case 5: Health = 2000 + PlayerPrefs.GetInt("Car5Armor");
			break;
